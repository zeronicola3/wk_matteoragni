...
$caption = $img_link_large = $link = $img_link_target = $alignment = $el_class = $css_animation = $style = $external_style = $border_color = $css = $wk_class = '';
$atts = vc_map_get_attributes( $this->getShortcode(), $atts );
extract( $atts );

if($atts['wk_full_width']){ $wk_class="wk_full_width";}
...
$wrapperClass = 'vc_single_image-wrapper ' . $style . ' ' . $border_color.' '. $wk_class;
...
$output = '
	<div class="' . esc_attr( trim( $css_class ) ) .'">
		...
		<figure class="wpb_wrapper vc_figure '. $wk_class.'">
			' . $html . '
		</figure>
	</div>
';
